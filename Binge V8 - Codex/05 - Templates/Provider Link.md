...
◇ WITH SHARED LOGO
<span class="provider-link"><img class="provider-logo inline" src="../07 - Data/Providers/Provider Logos/provider.svg" alt="Provider Name provider logo"> [Provider Name](https://example.com)</span>

◇ TABLE-SAFE LOGO
<img class="provider-logo inline" src="../07 - Data/Providers/Provider Logos/provider.svg" alt="Provider Name provider logo">
